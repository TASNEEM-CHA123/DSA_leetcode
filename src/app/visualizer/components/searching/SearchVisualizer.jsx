...
const SearchVisualizer = () => {
  ...
  const algorithm = searchParams.get('algorithm') || 'linear';
  const {
    searchArray,
    generateSearchArray,
    currentSearchIndex,
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="visualizer-navbar fixed right-0 z-40 p-4 border-b shadow-lg top-40 left-2 lg:top-24 md:left-[16rem]">
        <div className="flex flex-col items-center justify-between h-auto gap-4 mx-auto lg:mt-2 md:flex-row">
          <div className="flex items-center">
            <h2 className="text-2xl font-bold text-brand capitalize">
              {algorithm?.replace('-', ' ')}
            </h2>
          </div>
      ...
      {/* Settings Sidebar */}
      <motion.div
        className="visualizer-sidebar fixed top-0 right-0 z-50 h-full overflow-y-auto border-l shadow-xl"
      ...
      >
        ...
        <div className="p-6 pt-20">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-lg font-bold text-brand">Settings</h3>
            <button
              onClick={toggleSettingsSidebar}
      ...
      {/* Main Content Area */}
      <div className="flex flex-col h-[calc(100vh-10rem)] mt-36 md:mt-32">
        <div className="flex items-center justify-center flex-1 p-6 mx-4 relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-lg border border-slate-700">
