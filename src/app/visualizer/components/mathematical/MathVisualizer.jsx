...
const MathVisualizer = () => {
  ...
  const algorithm = searchParams.get('algorithm') || 'gcd-euclidean';
  ...
  return (
    <div className="h-full flex flex-col p-4">
            ...
            {algorithm === 'sieve-of-eratosthenes' && (
              <div>
                ...
                <p className="mt-1 text-xs text-gray-400">
                  Maximum value: 200 (for visualization clarity)
                </p>
              </div>
            )}
          ...
          <div className="text-sm text-gray-300">
            {algorithm === 'gcd-(euclidean)' ? (
              ...
              <>
                ...
                <p className="mt-2">
                  It works by iteratively marking as composite (non-prime) the
                  multiples of each prime, starting from 2.
                </p>
                <p className="mt-2">
                  The algorithm efficiently finds all the prime numbers up to a
                  specified integer.
                </p>
              </>
            ) : algorithm === 'prime-factorization' ? (
      ...
      <div className="flex-1 relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-lg border border-slate-700 overflow-hidden min-h-[400px]">
