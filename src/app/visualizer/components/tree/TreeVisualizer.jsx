...
const TreeVisualizer = () => {
  ...
  const algorithm = searchParams.get('algorithm') || 'tree-traversals';
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="fixed right-0 z-40 p-2 sm:p-4 shadow-lg top-20 md:top-26 left-64 bg-slate-800 border-b border-slate-700">
      ...
      {/* Main content */}
      <div className="flex flex-col h-[calc(100vh-4rem)] pt-16 md:pt-20 pb-4 px-2 sm:px-4">
        {/* Tree container */}
        <div
          ref={containerRef}
          className="flex-1 w-full h-full relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-lg border border-slate-700 touch-none overflow-hidden"
