...
const DPVisualizer = () => {
  ...
  const algorithm = searchParams.get('algorithm') || 'fibonacci';
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="visualizer-navbar fixed right-0 z-40 p-4 border-b shadow-lg top-16 left-0 lg:hidden">
      ...
      <div
        className={`visualizer-sidebar fixed right-0 top-0 h-full w-80 z-50 transform transition-transform duration-300 ease-in-out lg:hidden overflow-y-auto ${
