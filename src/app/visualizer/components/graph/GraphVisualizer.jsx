...
const GraphVisualizer = () => {
  ...
  const renderLogicalView = () => (
    <div className="flex items-center justify-center w-full h-full relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-lg border border-slate-700">
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="visualizer-navbar fixed right-0 z-40 p-2 sm:p-4 border-b shadow-lg top-16 left-0 md:left-64 overflow-x-auto lg:block hidden">
      ...
      <div className="flex flex-col lg:flex-row h-[calc(100vh-10rem)] pt-24 lg:pt-28">
      ...
      <div className="block lg:hidden fixed bottom-0 left-0 md:left-64 right-0 z-50">
