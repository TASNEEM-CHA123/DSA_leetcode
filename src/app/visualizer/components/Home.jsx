...
const AlgorithmCategory = ({
  ...
  return (
    <CardContainer className="h-full">
      <CardBody
        className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto h-full rounded-xl p-6 border"
        style={{
      ...
      >
        ...
        >
          ...
          <CardItem translateZ="50" className="flex-grow">
            <p className="mb-6 text-sm text-neutral-500 dark:text-neutral-300 md:text-base">
              {description}
            </p>
          </CardItem>
          ...
          <CardItem translateZ="30" className="w-full">
            <div className="flex items-center justify-between mt-auto pt-2 border-t border-neutral-200 dark:border-neutral-700">
              <Link
                href={
                  path === '/race-mode'
                    ? '/visualizer?category=race-mode'
                    : `/visualizer?category=${path.split('/')[1]}&algorithm=${algorithms.length > 0 ? algorithms[0].id : ''}`
                }
                className="text-sm font-medium transition-colors duration-300 flex items-center text-blue-400 hover:text-blue-300"
              >
                <span>
                  {algorithms.length > 0
...
const Home = () => {
  ...
  const handleExploreAlgorithmsClick = () => {
  ...
  return (
    <div className="visualizer-container flex flex-col w-full min-h-screen bg-background">
      <Seo
      ...
      <WavyBackground
        containerClassName="w-full min-h-screen absolute inset-0 bg-background"
      ...
      <div className="container relative z-10 flex-grow px-4 pt-24 pb-12 mx-auto">
        ...
        <div className="flex flex-col items-center justify-center flex-1 p-8 mt-20">
          ...
          <Cover>
            <h1 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-yellow-600 to-orange-600">
          ...
          <div className="flex mt-8 space-x-4">
            <HoverBorderGradient
              onClick={handleExploreAlgorithmsClick}
      ...
      {/* MobileSidebar popup for Explore Algorithms button */}
      <MobileSidebar
