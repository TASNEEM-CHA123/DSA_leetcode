...
const GreedyVisualizer = () => {
  ...
  const algorithm = searchParams.get('algorithm') || 'activity-selection';
  const {
    isPlaying,
    isPaused,
    speed,
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="visualizer-navbar fixed right-0 z-40 p-4 border-b shadow-lg top-26 left-64 hidden md:block">
