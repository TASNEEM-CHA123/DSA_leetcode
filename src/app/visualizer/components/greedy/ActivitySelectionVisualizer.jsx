...
const ActivitySelectionVisualizer = () => {
  ...
  const maxTime =
    activities.length > 0 ? Math.max(...activities.map(a => a.finish)) : 10;
    ...
    <div className="flex flex-col gap-4 mt-10">
      ...
      <div className="p-4 rounded-lg bg-slate-800">
        ...
        <p className="text-gray-300">
          ...
          non-conflicting activities that require exclusive use of a common
          resource, with the goal of maximizing the number of activities. The
          algorithm works by:
        </p>
              ...
              <div className="flex flex-wrap gap-2 mt-1">
                ...
                {selectedActivities.length === 0 && (
                  <span className="text-xs text-gray-400">
                    Run algorithm to see selected activities
                  </span>
                )}
              </div>
            </div>
        ...
        <div className="flex flex-wrap gap-2">
          {selectedActivities.length > 0 ? (
            ...
            <p className="text-gray-400">
              No activities selected yet. Press &quot;Start&quot; to run the
              algorithm.
            </p>
          )}
        </div>
