  ...
  const resourceLinks = [
    {
      ...
      href: '/visualizer?category=sorting&algorithm=bubble',
    },
    {
      name: 'Searching Algorithms',
      href: '/visualizer?category=searching&algorithm=linear',
    },
    {
      name: 'Graph Algorithms',
      href: '/visualizer?category=graph&algorithm=bfs',
    },
    {
      name: 'Dynamic Programming',
      href: '/visualizer?category=dynamic-programming&algorithm=fibonacci',
    },
    {
      name: 'Greedy Algorithms',
      href: '/visualizer?category=greedy-algorithm&algorithm=activity-selection',
    },
    {
      name: 'Backtracking',
      href: '/visualizer?category=backtracking&algorithm=n-queens',
    },
    {
      name: 'Tree Algorithms',
      href: '/visualizer?category=tree-algorithms&algorithm=binary-search-tree',
    },
    {
      name: 'Mathematical Algorithms',
      href: '/visualizer?category=mathematical-algorithms&algorithm=gcd-euclidean',
    },
    { name: 'Race Mode', href: '/visualizer?category=race-mode' },
    { name: 'FAQ', href: '/visualizer?category=faq' },
  ];
        ...
        >
          <motion.div variants={itemVariants}>
            <div className="flex items-start gap-1 mb-3">
              ...
              <div>
                <h3 className="logo-text text-lg font-bold leading-none">
                  SATrek
                </h3>
