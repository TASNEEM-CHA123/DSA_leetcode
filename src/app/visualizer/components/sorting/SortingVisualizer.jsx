...
const SortingVisualizer = () => {
  ...
  const algorithm = searchParams.get('algorithm') || 'bubble';
  const {
    array,
    generateNewArray,
    arraySize,
  ...
  // Use specialized visualizer for merge sort
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="visualizer-navbar fixed left-0 right-0 z-40 w-full p-2 pt-2 mt-4 border-b shadow-lg top-16 xl:left-64 sm:mt-6 xl:mt-8 sm:pt-3 xl:pt-3">
        ...
        <div className="flex flex-row items-center px-1 lg:mt-2 justify-evenly">
          <div className="flex items-center">
            <h2 className="mr-2 text-lg font-bold text-brand capitalize sm:text-xl lg:text-2xl">
              {algorithm?.replace('-', ' ')}
            </h2>
            {isSorted && (
          ...
          <div className="items-center hidden gap-2 lg:flex">
            ...
            <div className="flex items-center gap-1">
              <input
                ...
                disabled={isSorting}
                onKeyDown={e => e.key === 'Enter' && handleCustomArraySubmit()}
              />
              <button
      ...
      <div className="h-[calc(100vh-10rem)] mt-[20%] sm:mt-[15%] md:mt-[12%] lg:mt-10 pb-4">
        <div className="flex-1 p-2 mx-2 relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-lg border border-slate-700 sm:p-6 sm:mx-4">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-40 flex flex-row items-center justify-between w-full p-3 border-t shadow-lg sm:p-4 xl:left-64 bg-slate-800 border-slate-700">
        {/* Action Buttons */}
